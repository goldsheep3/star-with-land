...
<style>
    ...
    .frame     {width: 760px;margin: 10px auto;}
    #pyro      {color: #E2311D;}
    #cryo      {color: #98C8E8;}
    #anemo     {color: #33CCB3;}
    #electro   {color: #D376F0;}
    #hydro     {color: #1C72FD;}
    #dendro    {color: #7BB42D;}
    #geo       {color: #CFA726;}
...
<h2 id="pyro">火元素角色 / Pyro Characters</h2>
<table class="frame"><tr><td>
    ...
    <a href="../../images/gk/character/dehya.webp"><span class="thumbnail"><img id="fivestar" src="../../images/gk/icons/character/dehya.webp"  weight=72 height=72>迪希雅</span></a>
...
<h2 id="hydro">水元素角色 / Hydro Characters</h2>
<table class="frame"><tr><td>
...
<h2 id="anemo">风元素角色 / Anemo Characters</h2>
<table class="frame"><tr><td>
...
<h2 id="electro">雷元素角色 / Electro Characters</h2>
<table class="frame"><tr><td>
    ...
    <a href="../../images/gk/character/lisa.webp"><span class="thumbnail"><img id="fourstar" src="../../images/gk/icons/character/lisa.webp"  weight=72 height=72>丽莎</span></a>
...
<h2 id="dendro">草元素角色 / Dendro Characters</h2>
<table class="frame"><tr><td>    
...
<h2 id="cryo">冰元素角色 / Cryo Characters</h2>
<table class="frame"><tr><td>
...
<h2 id="geo">岩元素角色 / Geo Characters</h2>
<table class="frame"><tr><td>
...
<h2 id="other">其他角色 / Other Characters</h2>

旅行者、埃洛伊、原魔等暂无计划。

<h2 id="card">卡牌 / Cards</h2>
